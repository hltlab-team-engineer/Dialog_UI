...
public class Extras {
     ...
     */
    public static final String EXTRA_SERVICE_COMPONENT = "xyz.hiroshifuu.speechap.extra.SERVICE_COMPONENT";

    /**
     * String (must be a legal URL).
     * URL of a PGF or JSGF grammar.
     */
    public static final String EXTRA_GRAMMAR_URL = "xyz.hiroshifuu.speechap.extra.GRAMMAR_URL";

    /**
     * String.
     * Identifier of the target language in the given PGF grammar (e.g. "Est", "Eng").
     */
    public static final String EXTRA_GRAMMAR_TARGET_LANG = "xyz.hiroshifuu.speechap.extra.GRAMMAR_TARGET_LANG";
     ...
     */
    public static final String EXTRA_PHRASE = "xyz.hiroshifuu.speechap.extra.PHRASE";
     ...
     */
    public static final String EXTRA_VOICE_PROMPT = "xyz.hiroshifuu.speechap.extra.VOICE_PROMPT";

    /**
     * Bundle.
     * Information about the editor in which the IME is running.
     */
    public static final String EXTRA_EDITOR_INFO = "xyz.hiroshifuu.speechap.extra.EDITOR_INFO";

    /**
     * Boolean.
     * True iff the recognition service should not stop after delivering the first result.
     */
    public static final String EXTRA_UNLIMITED_DURATION = "xyz.hiroshifuu.speechap.extra.UNLIMITED_DURATION";
     ...
     */
    public static final String EXTRA_SEMI_FINAL = "xyz.hiroshifuu.speechap.extra.SEMI_FINAL";
     ...
     */
    public static final String EXTRA_AUDIO_CUES = "xyz.hiroshifuu.speechap.extra.AUDIO_CUES";
     ...
     */
    public static final String EXTRA_USE_EXTERNAL_EVALUATOR = "xyz.hiroshifuu.speechap.extra.USE_EXTERNAL_EVALUATOR";

    /**
     * Boolean.
     * Start the recognition session immediately without the user having to press a button.
     */
    public static final String EXTRA_AUTO_START = "xyz.hiroshifuu.speechap.extra.AUTO_START";
     ...
     */
    public static final String EXTRA_FINISH_AFTER_LAUNCH_INTENT = "xyz.hiroshifuu.speechap.extra.FINISH_AFTER_LAUNCH_INTENT";
     ...
     */
    public static final String EXTRA_RETURN_ERRORS = "xyz.hiroshifuu.speechap.extra.RETURN_ERRORS";
     ...
     */
    public static final String RESULTS_RECOGNITION_LINEARIZATIONS = "xyz.hiroshifuu.speechap.extra.RESULTS_RECOGNITION_LINEARIZATIONS";
    public static final String RESULTS_RECOGNITION_LINEARIZATION_COUNTS = "xyz.hiroshifuu.speechap.extra.RESULTS_RECOGNITION_LINEARIZATION_COUNTS";

    /**
     * Byte array. Currently not used.
     */
    public static final String RESULTS_AUDIO_ENCODED = "xyz.hiroshifuu.speechap.extra.RESULTS_AUDIO_ENCODED";

    /**
     * String (must be a Java regular expression).
     * Regular expression applied to the transcription result(s).
     */
    public static final String EXTRA_RESULT_UTTERANCE = "xyz.hiroshifuu.speechap.extra.RESULT_UTTERANCE";
     ...
     */
    public static final String EXTRA_RESULT_REPLACEMENT = "xyz.hiroshifuu.speechap.extra.RESULT_REPLACEMENT";

    /**
     * String.
     * Name of a command.
     */
    public static final String EXTRA_RESULT_COMMAND = "xyz.hiroshifuu.speechap.extra.RESULT_COMMAND";

    /**
     * String.
     * Content of the 1st argument of the command.
     */
    public static final String EXTRA_RESULT_ARG1 = "xyz.hiroshifuu.speechap.extra.RESULT_ARG1";

    /**
     * String.
     * Content of the 2nd argument of the command.
     */
    public static final String EXTRA_RESULT_ARG2 = "xyz.hiroshifuu.speechap.extra.RESULT_ARG2";
     ...
     * EXTRA_RESULT_ARG1 = "$1"
     */
    public static final String EXTRA_RESULT_LAUNCH_AS_ACTIVITY = "xyz.hiroshifuu.speechap.extra.RESULT_LAUNCH_AS_ACTIVITY";

    /**
     * String[].
     * List of transcription results.
     */
    public static final String EXTRA_RESULT_RESULTS = "xyz.hiroshifuu.speechap.extra.RESULT_RESULTS";
     ...
     */
    public static final String EXTRA_RESULT_REWRITES = "xyz.hiroshifuu.speechap.extra.RESULT_REWRITES";

    /**
     * String.
     * Rewrite table (in TSV-format and with a header) that should apply to the transcription results.
     */
    public static final String EXTRA_RESULT_REWRITES_AS_STR = "xyz.hiroshifuu.speechap.extra.RESULT_REWRITES_AS_STR";
     ...
     */
    public static final String EXTRA_LAUNCH_RECOGNIZER = "xyz.hiroshifuu.speechap.extra.LAUNCH_RECOGNIZER";
