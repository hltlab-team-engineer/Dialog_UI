...
import xyz.hiroshifuu.speechapp.commons.ImageLoader;
import xyz.hiroshifuu.speechapp.commons.ViewHolder;
import xyz.hiroshifuu.speechapp.models.IMessage;
import xyz.hiroshifuu.speechapp.models.MessageContentType;
import xyz.hiroshifuu.speechapp.utils.DateFormatter;
import xyz.hiroshifuu.speechapp.utils.RoundedImageView;
...
public class MessageHolders {
    ...
    public MessageHolders() {
        ...
        this.incomingTextConfig = new HolderConfig<>(DefaultIncomingTextMessageViewHolder.class, R.layout.item_incoming_text_message_self);
        this.outcomingTextConfig = new HolderConfig<>(DefaultOutcomingTextMessageViewHolder.class, R.layout.item_outcoming_text_message_self);
...
//                        Log.d("richLinkView", richLinkView.getMetaData().getDescription());
//                        Log.d("richLinkView", richLinkView.getMetaData().getTitle());
