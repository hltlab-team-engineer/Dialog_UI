...
public class SpeechRecognizerManager {
    ...
    public SpeechRecognizerManager(SpeechActivity context, onResultsReady listener) {
        ...
        String mServiceName = "xyz.hiroshifuu.speechapp/xyz.hiroshifuu.speechapp.service.WebSocketRecognitionService";
        mAudioManager = (AudioManager) context.getSystemService(Context.AUDIO_SERVICE);
        mRecognizerComponentName = ComponentName.unflattenFromString(mServiceName);
        mSpeechRecognizer = SpeechRecognizer.createSpeechRecognizer(context,mRecognizerComponentName);
        mSpeechRecognizer.setRecognitionListener(new SpeechRecognitionListener());
        mSpeechRecognizerIntent = new Intent(RecognizerIntent.ACTION_RECOGNIZE_SPEECH);
        //mSpeechRecognizerIntent.putExtra(RecognizerIntent.EXTRA_PROMPT, "Start Recording");
