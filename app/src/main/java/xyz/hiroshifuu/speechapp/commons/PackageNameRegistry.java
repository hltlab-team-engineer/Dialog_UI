...
import xyz.hiroshifuu.speechapp.utils.Utils;
...
public class PackageNameRegistry {
    ...
    public PackageNameRegistry(Context context, String packageName) {
        ...
        if (packageName == null) {
            ...
            //"context":xyz.hiroshifuu.speechapp.service.WebSocketRecognitionService
           //"packageName":xyz.hiroshifuu.speechapp
            // Notice: we use query instead of managedQuery


            //public final Cursor query (Uri uri, String[] projection,String selection,String[] selectionArgs, String sortOrder)
            //uri: 标识
            //projection：这个参数告诉Provider要返回的内容
            //selection：设置条件
